...
export async function middleware(request: NextRequest) {
  ...
  const csp = [
    "default-src 'self'",
    "script-src 'self' 'unsafe-eval' 'unsafe-inline' https://app.chatwoot.com https://sdk.cashfree.com https://meet.jit.si https://8x8.vc https://connect.facebook.net",
    "style-src 'self' 'unsafe-inline'",
    "img-src 'self' data: https:",
    "font-src 'self' https://app.chatwoot.com",
    "connect-src 'self' https://app.chatwoot.com wss://app.chatwoot.com https://api.cashfree.com https://payments.cashfree.com https://meet.jit.si wss://meet.jit.si https://8x8.vc wss://8x8.vc https://connect.facebook.net https://www.facebook.com https://graph.facebook.com https://twitter.com https://api.twitter.com",
    "frame-src 'self' https://app.chatwoot.com https://sdk.cashfree.com https://payments.cashfree.com https://meet.jit.si https://8x8.vc https://www.facebook.com https://twitter.com",
    "child-src 'self' https://app.chatwoot.com https://sdk.cashfree.com https://payments.cashfree.com https://meet.jit.si https://8x8.vc",
