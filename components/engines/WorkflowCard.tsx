...
export function WorkflowCard({ workflow, onExecute }: WorkflowCardProps) {
  ...
  return (
    <Card className="group relative overflow-hidden border-muted transition-all duration-300 hover:border-primary/20 hover:shadow-lg hover:shadow-primary/10">
      {/* Popular Badge */}
      {usageCount > 1500 && (
