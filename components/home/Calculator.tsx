...
export default function Calculator() {
  ...
  const oldCost = tools.reduce(
    (s, t) => s + (t.perSeat ? t.perSeat * size : (t.cost ?? 0)),
    0
  )
  ...
  return (
    <section id="calculator" className="mx-auto max-w-6xl px-5 py-16 lg:py-20">
      <div className="mx-auto mb-12 max-w-xl text-center">
        ...
        <p className="mt-3 text-base text-muted-foreground">
          Pick your business type or drag the slider. See the real cost
          difference.
        </p>
      </div>
              ...
              {tools.map(t => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="font-mono text-sm font-semibold text-red-500 line-through decoration-red-300">
                      ${c}
                    </span>
                  </div>
                )
          ...
          <div className="flex flex-col justify-between bg-gradient-to-br from-primary/5 to-background p-7">
            ...
            <div className="mt-8 rounded-xl bg-primary p-5 text-center text-white">
              ...
              <div className="font-mono text-3xl font-bold">
                ${saved.toLocaleString()}/yr
              </div>
              <Button
                asChild
                size="lg"
                className="mt-4 h-11 w-full rounded-lg bg-background font-semibold text-primary hover:bg-primary/10"
              >
                <Link href="/register">
