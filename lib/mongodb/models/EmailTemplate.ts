...
EmailTemplateSchema.methods.updateStats = function (
  openRate?: number,
  clickThroughRate?: number
) {
...
EmailTemplateSchema.statics.findByCategory = function (
  ...
  const query: any = {
    ...
    category,
    isActive: true,
    $or: [{ isShared: true }, { isSystem: true }],
  }
...
EmailTemplateSchema.statics.findByUser = function (
  userId: string,
  workspaceId: string
) {
  return this.find({
...
EmailTemplateSchema.statics.searchTemplates = function (
  query: string,
  workspaceId: string,
  userId?: string
) {
...
EmailTemplateSchema.statics.getPopular = function (
  workspaceId: string,
  limit: number = 10
) {
  return this.find({
