  ...
  const defaultRoles = [
    {
      ...
      permissions: [
        ...
        'chat.view', 'chat.send', 'chat.create_room', 'chat.manage_room', 'chat.delete_messages', 'chat.upload_files', 'chat.moderate',
    ...
    },
    {
      ...
      permissions: [
        ...
        'workspace.view',
        'members.view',
        'chat.view', 'chat.send', 'chat.create_room', 'chat.manage_room', 'chat.upload_files',
        'analytics.view', 'reports.view', 'reports.export',
        'settings.view',
        'activities.view', 'notifications.view',
      ],
      isDefault: false,
      createdBy: userId,
    },
    {
      ...
      permissions: [
        ...
        'workspace.view',
        'members.view',
        'chat.view', 'chat.send', 'chat.upload_files',
        'analytics.view',
        'settings.view',
        'activities.view', 'notifications.view',
      ],
